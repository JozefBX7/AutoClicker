...
- [Getting started](Getting-Started) — install, portable use, and the first run.
- [Using AutoClicker](Using-AutoClicker) — interval, actions, repeat rules, position, hotkeys, and the live test area.
...
- Left, middle, and right mouse input; single or double click.
- Space, Enter, or any picked keyboard key.
- Repeating until stopped or for a chosen number of runs.
- Fixed cursor coordinates or the current pointer position.
- Custom sequences with click, key, and independent wait events.
